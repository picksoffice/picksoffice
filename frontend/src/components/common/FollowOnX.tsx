        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">
              Follow me on social media for free picks, betting analysis, and insights that won't be
              published anywhere else. Join a community of serious sports bettors focused on
              long-term profitability through data-driven approaches.
            </p>
            <div className="mt-10 flex items-center gap-x-6">
              ...
              <ActionNetworkButton href="https://www.actionnetwork.com" isExternal={true} />
            </div>
          </div>
            ...
            <div className="flex justify-center items-center mx-auto">
              <div className="relative w-full max-w-[366px] max-h-[729px]">
                ...
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(circle, rgba(56,189,248,0.15) 0%, rgba(79,70,229,0.1) 45%, rgba(15,23,42,0) 70%)',
                  }}
                  aria-hidden="true"
                ></div>
                ...
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(circle, rgba(56,189,248,0.2) 0%, rgba(79,70,229,0.1) 60%, rgba(15,23,42,0) 75%)',
                  }}
                  aria-hidden="true"
                ></div>
                ...
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(ellipse, rgba(56,189,248,0.15) 0%, rgba(79,70,229,0.05) 50%, rgba(15,23,42,0) 70%)',
                  }}
                  aria-hidden="true"
                ></div>
