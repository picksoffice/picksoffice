...
export default function GradientBlobs() {
  return (
    <>
      ...
      <div aria-hidden="true" className="absolute left-[5%] top-[65%] -z-10 transform-gpu blur-2xl">
      ...
      <div aria-hidden="true" className="absolute right-0 bottom-0 -z-10 transform-gpu blur-3xl">
      ...
      <div aria-hidden="true" className="absolute left-0 top-0 -z-10 transform-gpu blur-2xl">
        <div className="aspect-[1/1] w-[20rem] rounded-full bg-gradient-to-r from-[#80caff] to-[#4f46e5] opacity-15" />
      </div>
