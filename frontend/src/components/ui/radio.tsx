...
const base = [
  ...
  'before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-dark-bg before:shadow-sm',
  // Background color when checked
  'group-data-checked:before:bg-(--radio-checked-bg)',
  // Background color is moved to control and shadow is removed in dark mode so hide `before` pseudo
  'before:hidden',
  // Background color applied to control in dark mode
  'bg-dark-bg/5 group-data-checked:bg-(--radio-checked-bg)',
  // Border
  ...
  'group-data-disabled:border-white/20 group-data-disabled:bg-dark-bg/[2.5%] group-data-disabled:[--radio-checked-indicator:var(--color-white)]/50 group-data-checked:group-data-disabled:after:hidden',
]
...
const colors = {
  ...
  sky: '[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-sky-300)] [--radio-checked-border:var(--color-sky-600)]/80',
