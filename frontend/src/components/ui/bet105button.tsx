...
const Bet105Button = forwardRef<HTMLButtonElement, Bet105ButtonProps>(
  ({ href, className = '', target = '_blank', ...props }, ref) => {
    const baseClasses = 'inline-flex items-center justify-center px-5 py-[19px] rounded-lg bg-[#3083dc] hover:bg-[#2471c6] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 h-[58px] text-center';
