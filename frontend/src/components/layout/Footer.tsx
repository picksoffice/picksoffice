...
const navigation = {
  sports: [
    { name: 'NBA', href: '/picks?sport=nba' },
    { name: 'NFL', href: '/picks?sport=nfl' },
    { name: 'MLB', href: '/picks?sport=mlb' },
    { name: 'NHL', href: '/picks?sport=nhl' },
  ],
  tools: [
    { name: 'Betting Splits', href: '/betting-splits' },
    { name: 'Odds Comparison', href: '/odds' },
    { name: 'Statistical Models', href: '/tools' },
    { name: 'Betting ABC', href: '/betting-abc' },
  ],
  resources: [
  ...
  social: [
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/picksoffice',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'Discord',
      href: 'https://discord.gg/picksoffice',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
