...
export async function fetchAPI<T>(
  ...
  const isPublicEndpoint =
    endpoint.startsWith('/picks') || endpoint.startsWith('/blogs') || skipAuth;
  ...
  try {
    ...
    try {
      ...
      console.log(
        `Response status for ${endpoint}: ${response.status}, Status Text: ${response.statusText}`
      );
  ...
  try {
    ...
    const mockData: Pick[] = [
      ...
      },
      {
        ...
        Result: 'Pending',
        Summary:
          "The Knicks' physical defense and rebounding advantage should keep this game close throughout.",
        Writeup:
      ...
      data: [
        {
          ...
          Summary:
            'The Wolves are showing incredible defensive prowess in this series and should cover the spread again.',
          Writeup:
            'After a dominant performance in Game 1, the Timberwolves continue to impress with their defensive intensity.',
          Slug: 'timberwolves-nuggets-apr25',
          createdAt: '2024-04-24T12:00:00Z',
          updatedAt: '2024-04-26T10:00:00Z',
          publishedAt: '2024-04-24T14:00:00Z',
