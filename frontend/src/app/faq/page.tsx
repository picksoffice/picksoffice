    ...
    faqs: [
      {
        ...
        answer: "PicksOffice combines advanced statistical methodology with cutting-edge algorithmic modeling to deliver high-precision picks. We maintain complete transparency in our record-keeping and focus on long-term profitability rather than short-term results."
      },
      {
        question: "How often are new picks published?",
        answer: "We typically publish 3-5 picks per week across all sports. Our focus is on quality over quantity, so we only release picks when our models identify significant value in the betting markets. During peak seasons for major sports like NFL, NBA, and MLB, you can expect more frequent selections."
      },
      {
        question: "Do you offer a money-back guarantee?",
        answer: "Yes, we offer a 30-day satisfaction guarantee for new subscribers. If you're not satisfied with our service within the first 30 days, contact our support team for a full refund. We believe in the quality of our picks and analysis and want you to feel confident in your subscription."
      },
      {
        question: "What's included in a premium subscription?",
        answer: "Premium subscribers receive access to all our picks with detailed analysis, early access to line movement alerts, personalized bankroll management recommendations, access to our members-only community, and priority customer support. You'll also get exclusive educational content to help improve your betting knowledge and skills."
      }
    ]
  },
  {
    ...
    faqs: [
      {
        ...
        answer: "You can cancel your subscription at any time from your account settings page. Select 'Subscription' from your profile menu, then click 'Cancel Subscription'. Your access will continue until the end of your current billing period. If you have any issues with cancellation, please contact our support team directly for assistance."
      },
      {
        question: "Can I share my account with friends?",
        answer: "Account sharing is not permitted. Each subscription is intended for individual use only. We monitor accounts for unusual login patterns that suggest sharing. If sharing is detected, we reserve the right to terminate the account without refund. If you're interested in group rates for multiple users, please contact our support team about our enterprise plans."
      },
      {
      ...
      },
      {
        ...
        answer: "We accept all major credit cards (Visa, Mastercard, American Express, Discover), PayPal, and select cryptocurrencies including Bitcoin and Ethereum. All transactions are processed securely through industry-standard payment processors with encryption to protect your financial information."
      }
    ]
  }
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Find answers to common questions about sports betting, our methodology, and how to maximize your betting success.
            </p>
          </div>
