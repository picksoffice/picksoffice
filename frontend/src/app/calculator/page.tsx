...
const calculatorTools = [
  {
    ...
    description:
      'Convert odds between American, Decimal, Fractional, and Implied Probability formats with our easy-to-use calculator.',
  ...
  },
  {
    ...
    description:
      'Calculate your closing line value to measure your ability to beat the market and predict long-term profitability.',
  ...
  },
  {
    ...
    description:
      'Calculate potential payouts for parlay bets with multiple selections using different odds formats.',
  ...
  },
  {
    ...
    description:
      'Optimize your bet sizing with the Kelly Criterion formula to maximize long-term growth rate of your bankroll.',
  ...
  },
  {
    ...
    description:
      'Calculate the expected value of your bets to determine if they have positive long-term value.',
        ...
        <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-400 max-w-3xl">
              Our free betting calculators help you make informed decisions and optimize your sports
              betting strategy. Convert odds between different formats, calculate potential payouts,
              and more.
            </p>
          </div>
            ...
            {calculatorTools.map(tool => (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="text-sky-300">{tool.icon}</div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Convert odds between different formats to better understand the true probability
                  and value of your bets.
                </p>
              </div>
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                <h3 className="text-xl font-medium mb-2 text-white">Optimize Your Strategy</h3>
                <p className="text-gray-400">
                  Use tools like the Kelly Calculator to determine optimal bet sizes based on your
                  edge and bankroll.
                </p>
              </div>
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Measure your betting success with CLV Calculator to see if you are consistently
