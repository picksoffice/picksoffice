...
export default function OddsConverter() {
  ...
  const getInputPlaceholder = () => {
    switch (oddsFormat) {
      case 'american': return 'e.g., -110, +150';
      case 'decimal': return 'e.g., 1.91, 2.50';
      case 'fractional': return 'e.g., 10/11, 3/2';
      case 'impliedProbability': return 'e.g., 52.38, 40';
      default: return '';
    }
  };
        ...
        <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-400 max-w-3xl">
              Convert odds between American, Decimal, Fractional, and Implied Probability formats 
              to better understand potential payouts and probabilities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              <div className="rounded-2xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10 ring-1 ring-white/10">
                ...
                <div className="mb-6">
                  <label htmlFor="odds-input" className="block text-sm font-medium text-gray-300 mb-2">
                    Enter {oddsFormat === 'american' ? 'American' : 
                           oddsFormat === 'decimal' ? 'Decimal' :
                           oddsFormat === 'fractional' ? 'Fractional' : 'Implied Probability'} Odds
                  </label>
                  <input
                    id="odds-input"
                    type="text"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="rounded-lg bg-slate-800/50 p-4">
                    ...
                    <div className="text-xl font-semibold">
                      {americanOdds !== undefined ? (americanOdds > 0 ? `+${americanOdds}` : americanOdds) : '—'}
                    </div>
                  </div>
                  <div className="rounded-lg bg-slate-800/50 p-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      Displayed with + or - sign. +150 means a $100 bet wins $150. -150 means you need to bet $150 to win $100.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      Popular in Europe and Canada. The number represents the total return (including stake) for each unit bet.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      Common in the UK. Displayed as a fraction (e.g., 5/1). Represents profit relative to stake.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      The chance of winning as implied by the odds. Useful for comparing value across different markets.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Choose the format of the odds you want to convert from: American, Decimal, Fractional, or Implied Probability.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Type in the odds value using the correct format. For American odds, include the + or - sign.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Instantly see the odds converted to all other formats to compare and make informed decisions.
                </p>
              </div>
            </div>
          </div>
