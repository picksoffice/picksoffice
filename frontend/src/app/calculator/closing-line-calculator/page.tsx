  ...
  const calculateResult = () => {
    ...
    try {
      ...
      if (oddsFormat === 'american') {
        ...
        if (isNaN(placedDecimal) || isNaN(closingDecimal) || placedDecimal < 1 || closingDecimal < 1) {
      ...
      if (clvPercentage > 3) {
        setEdgeDescription('Excellent edge! You have a significant advantage over the closing line.');
      } else if (clvPercentage > 1) {
        setEdgeDescription('Good edge. You consistently beat the closing line, which indicates positive expected value.');
        ...
        setEdgeDescription('Slight negative edge. The closing line is slightly better than your odds.');
      } else if (clvPercentage > -3) {
        setEdgeDescription('Negative edge. The closing line is better than your odds, suggesting negative expected value.');
      } else {
        ...
        <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-400 max-w-3xl">
              Calculate how much value you captured compared to the closing line. Consistently beating the closing line 
              is a strong indicator of long-term profitability in sports betting.
            </p>
          </div>
            ...
            <div className="md:col-span-2">
              <div className="rounded-2xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10 ring-1 ring-white/10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    <label htmlFor="placed-odds" className="block text-sm font-medium text-gray-300 mb-2">
                      Your Bet Odds
                    </label>
                    <input
                      id="placed-odds"
                  ...
                  <div>
                    <label htmlFor="closing-odds" className="block text-sm font-medium text-gray-300 mb-2">
                      Closing Odds
                    </label>
                    <input
                      id="closing-odds"
                      ...
                      placeholder={oddsFormat === 'american' ? "e.g., -120, +140" : "e.g., 1.83, 2.40"}
                      className="w-full bg-slate-800 border-slate-700 rounded-md py-2 px-3 text-white placeholder-gray-500 focus:ring-sky-500 focus:border-sky-500"
                    />
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className={`text-2xl font-semibold ${
                          clvResult > 0 ? 'text-emerald-400' : 
                          clvResult < 0 ? 'text-red-400' : 'text-white'
                        }`}>
                          {clvResult > 0 ? '+' : ''}{clvResult}%
                        </div>
                      </div>
                      <div>
            ...
            <div>
              <div className="rounded-2xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10 ring-1 ring-white/10">
                ...
                <p className="text-sm text-gray-400 mb-4">
                  Closing Line Value (CLV) measures how much better or worse your odds were compared to the final odds right 
                  before the event started (the closing line).
                </p>
                
                <h3 className="font-medium text-sky-300 mt-4">Why CLV Matters</h3>
                <p className="text-sm text-gray-400 mt-1">
                  Consistently getting better odds than the closing line is a strong predictor of long-term profitability.
                  It means you are accurately identifying value before the market does.
                </p>
                
                <h3 className="font-medium text-sky-300 mt-4">How to Interpret CLV</h3>
                <ul className="text-sm text-gray-400 mt-1 space-y-2">
                  <li><span className="text-emerald-400">Positive CLV</span>: You got better odds than the closing line.</li>
                  <li><span className="text-white">Zero CLV</span>: Your odds matched the closing line.</li>
                  <li><span className="text-red-400">Negative CLV</span>: The closing line had better odds than you got.</li>
                </ul>
                
                <h3 className="font-medium text-sky-300 mt-4">Expert Insight</h3>
                <p className="text-sm text-gray-400 mt-1">
                  Sharp bettors aim for a positive CLV of at least 1-2% on average. Consistently achieving this level of CLV 
                  indicates a sustainable edge over the market.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Record the odds you get for each bet and compare them to the closing line. Calculate your average CLV over time.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Identify which types of bets, sports, or situations consistently give you positive CLV and focus more on those areas.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  If you consistently achieve positive CLV, you can be confident in your long-term betting strategy, even during losing streaks.
                </p>
              </div>
            </div>
          </div>
