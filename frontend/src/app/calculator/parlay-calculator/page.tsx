        ...
        <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-400 max-w-3xl">
              Calculate potential payouts for parlay bets with multiple selections. Add legs to your
              parlay and see how each selection affects your potential winnings.
            </p>
          </div>
                  ...
                  {selections.map((selection, index) => (
                    <div key={selection.id} className="bg-slate-800/50 p-4 mb-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label
                            htmlFor={`description-${selection.id}`}
                            className="block text-sm font-medium text-gray-300 mb-1"
                          >
                          ...
                          <input
                            ...
                            onChange={e =>
                              updateSelection(selection.id, 'description', e.target.value)
                            }
            ...
            <div>
              <div className="rounded-2xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10 ring-1 ring-white/10">
                ...
                <p className="text-sm text-gray-400 mb-4">
                  A parlay is a single bet that combines two or more individual wagers for a
                  potentially higher payout. The catch is that all selections must win for the
                  parlay to pay out.
                </p>
                ...
                <p className="text-sm text-gray-400 mt-1">
                  ...
                  together. The more selections you add, the higher your potential payout — but also
                  the lower your chances of winning.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Limit the number of selections in your parlay. Each additional leg significantly
                  decreases your chances of winning.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Look for bets that are correlated. If one leg is likely to win, it should increase
                  the chances of other legs winning too.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-slate-800/30 backdrop-blur-sm p-6 shadow-lg border border-white/10">
                ...
                <p className="text-gray-400">
                  Use parlays for entertainment, not as your primary betting strategy. Small stakes
                  can still provide excitement without risking too much.
                </p>
              </div>
            </div>
          </div>
