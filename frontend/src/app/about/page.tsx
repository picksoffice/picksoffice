...
export default function AboutPage() {
  return (
    <div className="relative isolate overflow-hidden min-h-screen">
      {/* After hero section blob */}
      <div
        aria-hidden="true"
        className="absolute right-[10%] top-[calc(100vh-10rem)] -z-10 transform-gpu blur-3xl"
      >
        <div
          style={{
            clipPath:
      ...
      <div
        aria-hidden="true"
        className="absolute left-[5%] top-[130vh] -z-10 transform-gpu blur-2xl"
      >
      ...
      {/* Bottom blob */}
      <div aria-hidden="true" className="absolute right-0 top-[180vh] -z-10 transform-gpu blur-3xl">
      ...
      {/* FAQ section accent blob */}
      <div
        aria-hidden="true"
        className="absolute left-1/2 top-[220vh] -translate-x-1/2 -z-10 transform-gpu blur-2xl"
      >
        <div className="aspect-[2/1] w-[30rem] rounded-[50%] bg-gradient-to-r from-[#80caff] to-[#4f46e5] opacity-10" />
      </div>
